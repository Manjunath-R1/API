...
namespace ThoughtFocus.DataAccess.Migrations
{
    public partial class add_seeding_forgotpassword_email_template : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT [Notification].[ActivityNotification] ([ActivityNotificationID], [ActivityID], [NotificationID],[WorkflowNotificationTypeID],[IsActive],[CreatedDateTime],[CreatedByUserID],[LastModifiedDateTime],[LastModifiedByUserID]) VALUES (27, 0, 16,3,1,N'2021-04-02 12:49:45.760',1,N'2021-04-02 12:49:45.760',1)");
            ...
            migrationBuilder.Sql("INSERT [Notification].[NotificationRecipients] ([NotificationRecipientID],[ActivityNotificationID],[PlaceholderID],[IsTo],[IsCC],[IsActive],[CreatedDateTime],[CreatedByUserID],[LastModifiedDateTime],[LastModifiedByUserID]) VALUES ( 58,27,1,1,0,1, N'2021-04-02 12:49:45.760',1,N'2021-04-02 12:49:45.760',1)");
        ...
        {             
             migrationBuilder.Sql("delete from [Notification].[NotificationRecipients]  where NotificationRecipientID =58");
             migrationBuilder.Sql("delete from [Notification].[ActivityNotification] where ActivityNotificationID =27"); 
             migrationBuilder.Sql("delete from [Master].[Notification] where NotificationID =16");
